...
export default function RealEstateDashboardPage() {
  ...
  return (
    <div className="flex min-h-screen bg-background text-on-surface selection:bg-primary selection:text-on-primary">
      {/* Sleek Institutional Sidebar Navigation */}
      <aside className="hidden w-72 flex-col border-r border-outline-variant/30 bg-surface-container-lowest lg:flex shrink-0">
        {/* Brand Header */}
        <div className="flex h-20 items-center gap-3 border-b border-outline-variant/30 px-6">
          <div className="flex h-10 w-10 items-center justify-center bg-primary/10 border border-primary/40 text-primary">
          ...
          <div>
            ...
            <span className="block font-label-md text-[10px] uppercase tracking-widest text-primary">
              Private Portal
            </span>
          </div>
        </div>
        ...
        <div className="flex-1 space-y-8 overflow-y-auto p-6">
          ...
          <div>
            <p className="section-eyebrow mb-3 text-[10px]">Command Centre</p>
            <nav className="space-y-1">
              <button
                type="button"
                onClick={() => handleNavClick("Dashboard")}
                className={`flex w-full items-center gap-3 px-4 py-3 font-label-md text-xs uppercase tracking-widest transition-all duration-200 ${
                  activeNav === "Dashboard"
          ...
          <div>
            <p className="section-eyebrow mb-3 text-[10px]">My Investments</p>
            <nav className="space-y-1">
              {[
          ...
          {/* Group 3: Discover */}
          <div>
            <p className="section-eyebrow mb-3 text-[10px]">Discover</p>
            <nav className="space-y-1">
              {[
          ...
          {/* Group 4: Services */}
          <div>
            <p className="section-eyebrow mb-3 text-[10px]">Services</p>
            <nav className="space-y-1">
              {[
          ...
          <div>
            <p className="section-eyebrow mb-3 text-[10px]">Reports & Analytics</p>
            <nav className="space-y-1">
              {[
        ...
        <div className="border-t border-outline-variant/30 p-4">
          <div className="flex items-center justify-between bg-surface-container/80 p-3 border border-outline-variant/20">
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center bg-primary text-xs font-bold text-on-primary">
                JK
              </div>
              <div className="overflow-hidden">
                <p className="truncate text-xs font-semibold text-on-surface">Joseph Kiran</p>
                <p className="truncate font-label-md text-[10px] text-primary uppercase tracking-widest">Premium Investor</p>
              </div>
            </div>
            <Link
              href="/"
              title="Return to home"
              className="flex h-8 w-8 items-center justify-center text-on-surface-variant hover:bg-surface-container-highest hover:text-primary transition-colors"
            >
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-20 items-center justify-between border-b border-outline-variant/30 bg-surface-container-lowest/80 px-8 backdrop-blur-md">
          <div className="flex items-center gap-4">
            <h1 className="font-headline-lg text-xl md:text-2xl text-on-surface">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative hidden md:block">
              ...
              <input
                ...
                className="w-72 border border-outline-variant/40 bg-surface-container py-2 pl-10 pr-4 text-xs text-on-surface placeholder:text-on-surface-variant/60 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary transition-all"
              />
            </div>
            ...
            <button
              ...
              className="relative flex h-10 w-10 items-center justify-center border border-outline-variant/40 bg-surface-container text-on-surface-variant hover:border-primary hover:text-primary transition-all"
              title="Notifications"
            >
              <span className="material-symbols-outlined text-[20px]">notifications</span>
              <span className="absolute -right-0.5 -top-0.5 flex h-4 w-4 items-center justify-center bg-primary text-[10px] font-bold text-on-primary">
                3
              </span>
            </button>
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center border border-outline-variant/40 bg-surface-container text-on-surface-variant hover:border-primary hover:text-primary transition-all"
            ...
            <div className="flex h-9 w-9 items-center justify-center bg-primary text-xs font-bold text-on-primary lg:hidden">
              JK
            </div>
          </div>
        </header>
        ...
        <main className="flex-1 overflow-y-auto p-6 md:p-10 space-y-12">
          ...
          <section className="glass-panel p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl space-y-6">
              ...
              <h2 className="font-display-xl text-3xl md:text-5xl text-on-surface leading-tight">
                Welcome Back, Joseph
              </h2>
              ...
              <div className="pt-4 flex flex-wrap items-center gap-4">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary text-on-primary font-label-md uppercase tracking-widest luxury-button"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 border border-primary text-primary font-label-md uppercase tracking-widest hover:bg-primary/10 transition-colors bg-transparent"
                >
                  Sell My Property
                </button>
              </div>
          ...
          <section className="space-y-6">
            <div className="flex items-center justify-between border-b border-outline-variant/20 pb-4">
              <div>
                <span className="section-eyebrow block mb-1">Performance tracking</span>
                <h3 className="font-headline-lg text-2xl md:text-3xl text-on-surface">
                  Your Portfolio – At a Glance
                </h3>
                <p className="section-body text-sm mt-1">
            ...
            <div className="grid grid-cols-1 gap-gutter sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="glass-panel p-6 md:p-8 transition-all duration-300 hover:border-primary/60 group">
                ...
                <p className="mt-6 font-display-xl text-3xl font-bold text-on-surface">₹2.48 Cr</p>
                <p className="mt-2 section-body text-xs">
              ...
              <div className="glass-panel p-6 md:p-8 transition-all duration-300 hover:border-primary/60 group">
                ...
                <div className="mt-6 flex items-baseline gap-2">
                  <p className="font-display-xl text-3xl font-bold text-emerald-400">+18.6%</p>
                </div>
                <p className="mt-2 section-body text-xs">
              ...
              <div className="glass-panel p-6 md:p-8 transition-all duration-300 hover:border-primary/60 group">
                ...
                <p className="mt-6 font-display-xl text-3xl font-bold text-on-surface">7</p>
                <p className="mt-2 section-body text-xs">
              ...
              <div className="glass-panel p-6 md:p-8 transition-all duration-300 hover:border-primary/60 group">
                ...
                <div className="mt-6 flex items-center gap-2">
                  <p className="font-display-xl text-3xl font-bold text-on-surface">Verified</p>
                  <span className="flex h-5 w-5 items-center justify-center bg-emerald-500/20 text-emerald-400 text-xs font-bold">
                    ✓
                  </span>
                </div>
                <p className="mt-2 section-body text-xs">
                  <span className="text-primary font-semibold">100%</span> All Clear & Compliant
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="recommended-opportunities" className="space-y-8 pt-4">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between border-b border-outline-variant/20 pb-4">
              <div>
                <span className="section-eyebrow block mb-1">Curated For You</span>
                <h3 className="font-headline-lg text-2xl md:text-3xl text-on-surface">
                  Recommended Investment Opportunities
                </h3>
                <p className="section-body text-sm mt-1">
              ...
              {RECOMMENDED_OPPORTUNITIES.map((opp) => (
                ...
                >
                  ...
                  <div className="relative h-64 w-full overflow-hidden bg-surface-container">
                    ...
                    {/* Badge */}
                    <span className="absolute left-4 top-4 bg-primary text-on-primary font-label-md uppercase tracking-widest text-[10px] px-3 py-1">
                      {opp.badge}
                    </span>
                    ...
                    <button
                      ...
                      className="absolute right-4 top-4 flex h-9 w-9 items-center justify-center bg-black/60 text-on-surface hover:bg-primary hover:text-on-primary transition-all border border-white/10"
                    >
                    ...
                    <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between text-xs">
                      ...
                      <div className="bg-black/80 px-3 py-1.5 text-right border border-white/10">
                        <span className="font-label-md text-[9px] uppercase tracking-widest text-on-surface-variant block">Investment Score</span>
                        <span className="font-bold text-primary font-mono">{opp.score}/100</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-1 flex-col justify-between p-6 space-y-6">
                    <div className="space-y-4">
                      <h4 className="font-headline-lg text-xl text-on-surface group-hover:text-primary transition-colors leading-snug">
                        {opp.title}
                      </h4>
                      <p className="section-body text-xs flex items-center gap-1.5">
                    ...
                    <div className="flex items-center justify-between border-t border-outline-variant/20 pt-6">
                      <div>
                        ...
                        <p className="font-display-xl text-2xl font-bold text-primary">
                          {opp.price}{" "}
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-on-primary font-label-md uppercase tracking-widest text-xs luxury-button"
                      >
                        View Details
                        <span className="material-symbols-outlined text-[16px]">arrow_forward</span>
                      </button>
            ...
            <div className="glass-panel p-8 md:p-10 space-y-8">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 border-b border-outline-variant/20 pb-4">
                <div>
                  <span className="section-eyebrow block mb-1">Macro Intelligence</span>
                  <h4 className="font-headline-lg text-xl md:text-2xl text-on-surface">
                ...
                {MARKET_FUNDAMENTALS.map((item, idx) => (
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="section-body text-xs leading-relaxed">
                        {item.description}
                      </p>
                    </div>
                  </div>
          ...
          <section className="grid grid-cols-1 gap-gutter lg:grid-cols-2 pt-4">
            {/* Left Column: Your Next Step */}
            <div className="glass-panel p-8 md:p-10 flex flex-col justify-between space-y-8">
              <div className="space-y-3">
                <span className="section-eyebrow block">Action Oriented</span>
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="flex w-full items-center justify-between p-5 bg-primary text-on-primary font-label-md uppercase tracking-widest text-xs luxury-button"
                >
                  <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="flex w-full items-center justify-between p-5 border border-primary text-primary font-label-md uppercase tracking-widest text-xs hover:bg-primary/10 transition-colors bg-transparent"
                >
                  <div className="flex items-center gap-3">
            ...
            <div className="glass-panel p-8 md:p-10 flex flex-col justify-between space-y-8">
              <div className="flex items-center justify-between border-b border-outline-variant/20 pb-4">
                <div>
                  <span className="section-eyebrow block mb-1">Intelligence Feed</span>
                  <h3 className="font-headline-lg text-2xl text-on-surface">
                ...
                {MARKET_UPDATES.map((update) => (
                  ...
                  >
                    <div className="space-y-1.5">
                      <h4 className="font-headline-lg text-base text-on-surface group-hover:text-primary transition-colors">
                        {update.title}
                      </h4>
                      <p className="section-body text-xs leading-relaxed">
                        {update.summary}
                    ...
                    <div className="text-right shrink-0">
                      <span className="font-label-md text-[10px] text-on-surface block">{update.date}</span>
                      <span className="font-label-md text-[9px] text-primary uppercase tracking-widest">{update.time}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="space-y-1">
                  ...
                  <h3 className="font-headline-lg text-2xl text-on-surface">Priya Nair</h3>
                  <p className="section-body text-xs">Senior Investment Advisor</p>
                  <div className="mt-2 flex items-center gap-1 text-xs text-primary">
                    <span>★★★★★</span>
                    <span className="text-on-surface font-semibold">4.9</span>
                    <span className="section-body text-xs">(128 Reviews)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 border border-outline-variant/50 bg-surface text-on-surface font-label-md uppercase tracking-widest text-xs hover:border-primary hover:text-primary transition-all"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 border border-outline-variant/50 bg-surface text-on-surface font-label-md uppercase tracking-widest text-xs hover:border-emerald-400 hover:text-emerald-400 transition-all"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-primary text-on-primary font-label-md uppercase tracking-widest text-xs luxury-button"
                >
          ...
          <footer className="flex flex-col items-center justify-between gap-4 border-t border-outline-variant/20 pt-8 pb-4 section-body text-xs sm:flex-row">
