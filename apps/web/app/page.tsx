...
export default function HomePage() {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter items-start relative z-10">
    {/* Left Content */}
    <div>
      <SectionHeader
        eyebrow="Our Edge"
      ...
      <div className="space-y-8">
        {[...advantages, ...whyChooseUs].map((item, i) => (
          <FadeIn key={item.title} delay={i * 0.1} direction="left">
            ...
            >
              ...
              <div>
                <h4 className="font-headline-lg text-xl text-on-surface mb-2">
                  {item.title}
                </h4>
    ...
    <FadeIn
      delay={0.2}
      direction="right"
      className="relative h-[580px] md:h-[660px] w-full"
    >
      {/* Image */}
      <div
      ...
      {/* Location Badge */}
      <div className="absolute top-5 left-5 z-10 px-3 py-1.5 border border-primary/25 backdrop-blur-md bg-background/50 rounded-sm">
        <span className="font-label-md text-[10px] uppercase tracking-[0.25em] text-primary">
          Bangalore · Premium Corridor
        </span>
      </div>

      {/* Portfolio Yield Card */}
      <motion.div
        className="absolute bottom-5 left-5 right-5 z-10 bg-background/90 backdrop-blur-md p-6 border border-outline-variant/30 rounded-sm"
        initial={{ opacity: 0, y: 20 }}
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <span className="font-label-md text-on-surface-variant uppercase tracking-[0.25em] text-xs">
            Portfolio Yield
          </span>
        ...
        <div className="w-full bg-surface-container h-[2px] mb-3 rounded-full overflow-hidden">
          <motion.div
        ...
        <p className="section-body text-xs text-on-surface-variant">
              ...
              {[
                ...
                <FadeIn key={stat.label} delay={i * 0.1}>
                  <div className="border-l-2 border-primary/40 pl-6">
                    ...
                    <p className="font-headline-lg text-xl text-primary">
                      {stat.value}
                    </p>
                  </div>
                </FadeIn>
